    ...
    collections: [
      {
        ...
        fields: [
                            ...
                            <span style={{ display: "flex", alignItems: "center", justifyContent: "center", position: "relative", width: "18px", height: "18px" }}>
                              <input
                                ...
                                style={{ 
                                  ...
                                  backgroundColor: isChecked ? "#E31E24" : "#ffffff", border: isChecked ? "2px solid #E31E24" : "2px solid #d1d5db", transition: "all 0.1s ease", margin: 0, display: "block"
                                }}
                                onChange={(e) => {
          ...
          { 
            ...
            options: ["black", "white", "blue", "red", "gray", "tan", "green"]
          },
